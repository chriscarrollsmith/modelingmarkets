...
A version of this chart made the rounds earlier this year, as inflation soared. Plot historical 10-year bond yields against historical PCE inflation rates, run a simple log regression, and voila! Bond yields are still way too low, and *voila!* today’s 10-year yield should be `r paste(round(initial_predicted_yield,1),"%",sep="")`!
